...
const restaurantOptions = [
  'McDonald\'s', 'KFC', 'Pizza Hut', 'Burger\nKing', 'Subway', 'Starbucks', 'Taco\nBell', 'Domino\'s', 'Dunkin\'', 'Popeyes', 'LekYai', 'Teaw', 'PadKraPrao', 'Bonchon', 'Japan', 'Korean', 'EatAmAre', 'Sizler'
];
...
const RoomLobby: React.FC<RoomLobbyProps> = ({
  ...
  return (
      ...
      >
          <Card className="p-6 max-w-lg w-full mx-auto bg-white bg-opacity-90 shadow-lg rounded-lg">
